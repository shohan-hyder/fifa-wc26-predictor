...
// ✅ CORRECTED: Knockout bracket structure (Round of 32) - EXACTLY 16 MATCHES
// FIFA 2026 bracket: two separate pathways to prevent top-4 meeting before semis
export const BRACKET_TEMPLATE = {
  r32: [
    // ── PATHWAY 1 (Top Half: France side) ──
    { id: "r32_1", slot1: "A1", slot2: "3rd_C/D/E/F" },
    { id: "r32_2", slot1: "C1", slot2: "3rd_A/B/G/H" },
    { id: "r32_3", slot1: "E1", slot2: "3rd_A/B/G/H" },
    { id: "r32_4", slot1: "G1", slot2: "3rd_C/D/E/F" },
    { id: "r32_5", slot1: "I1", slot2: "3rd_I/J/K/L" },  // France's side
    { id: "r32_6", slot1: "K1", slot2: "3rd_I/J/K/L" },
    { id: "r32_7", slot1: "B2", slot2: "F2" },
    { id: "r32_8", slot1: "D2", slot2: "H2" },
    
    // ── PATHWAY 2 (Bottom Half: Spain/Argentina/England side) ──
    { id: "r32_9", slot1: "B1", slot2: "3rd_A/B/G/H" },
    { id: "r32_10", slot1: "D1", slot2: "3rd_C/D/E/F" },
    { id: "r32_11", slot1: "F1", slot2: "3rd_I/J/K/L" },
    { id: "r32_12", slot1: "H1", slot2: "3rd_I/J/K/L" },  // Spain's side
    { id: "r32_13", slot1: "J1", slot2: "3rd_C/D/E/F" },  // Argentina's side
    { id: "r32_14", slot1: "L1", slot2: "3rd_A/B/G/H" },  // England's side
    { id: "r32_15", slot1: "A2", slot2: "E2" },
    { id: "r32_16", slot1: "C2", slot2: "G2" },
  ],
};

// Third-place slot mapping for FIFA pathway logic
